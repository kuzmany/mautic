...
class StatRepository extends CommonRepository
{
     ...
     */
    public function getOpenedRates($emailIds, \DateTime $fromDate = null, \DateTime $toDate = null)
    {
     ...
     */
    public function getSentCounts($emailIds = [], \DateTime $fromDate = null, \DateTime $toDate = null)
    {
        $q = $this->_em->getConnection()->createQueryBuilder();
