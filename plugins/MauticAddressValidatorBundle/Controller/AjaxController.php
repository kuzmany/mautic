...
class AjaxController extends CommonAjaxController
{
    ...
    public function generateAction(Request $request){
        $url = $this->request->getSchemeAndHttpHost().$this->request->getBaseUrl();

        $integrationHelper = $this->get('mautic.helper.integration');
        $integration = $integrationHelper->getIntegrationObject('AddressValidator');
        $featureSettings = $integration->getDecryptedApiKeys();
        $apiUrl = $featureSettings['apiUrl'];
